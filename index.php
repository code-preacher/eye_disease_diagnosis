...
<head>
    ...
    <title>EYE DISEASE DIAGNOSIS SYSTEM!</title>
                ...
                <div class="container">
                    <div class="navbar-header pull-left">
                        <a class="navbar-brand page-scroll" href="#page-top">
                            ...
                            <span class="brand-logo">EYE DISEASE DIAGNOSIS SYSTEM</span>
                        </a>
                    </div>
            ...
            <header id="intro-carousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <div class="carousel-caption">
                            <h1 class="wow animated slideInDown">Welcome to EYE DISEASE DIAGNOSIS SYSTEM! </h1>
                            <p class="intro-text wow animated slideInUp"></p>
                            <p class="intro-text wow animated slideInUp"></p>
                            <a href="login.php" class="btn btn-default btn-lg">Get Started</a>
                        </div>
                    ...
                    <div class="item">
                        ...
                        <div class="fill" style="background-image:url('images/sl22.jpg');"></div>
                        <div class="carousel-caption">
                            <h1 class="wow animated slideInDown">Diagnise yourself </span> </h1>
                            <p class="intro-text wow animated slideInUp">today ....?</p>
                             <a href="login.php" class="btn btn-default btn-lg">Get Started</a>
                        </div>
                        <div class="overlay-detail"></div>
                    </div><!-- /.item -->
                ...
                <div class="mouse"></div>
                            ...
                            <div class="col-md-12 text-center">
                                &copy; 2021.EYE DISEASE DIAGNOSIS SYSTEM! All rights reserved.
                            </div><!-- /.col-md-12 -->
